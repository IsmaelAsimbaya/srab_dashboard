...
const ActMarcacion = () => {
  ...
  const handleUpdate = async (row) => {
    ...
    try {
      ...
      setRows(updatedRows);
      alert("Se ha modificado los datos de Marcación");
    }
    catch (error) {
      console.error("Error al obtener datos de Marcación:", error);
      alert("No se pudieron modificar los datos de Marcación");
    };
    row.id_usuario = 0;
    row.fecha = "";
    row.hora = "";
  ...
  return (
    <Box m="20px">
      <Header
        title="ACTUALIZAR MARCACIÓN"
        subtitle="Actualiza los datos especificados de la marcación."
      />
